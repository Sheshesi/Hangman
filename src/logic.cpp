...
void loadFromFile(
        vector<Sprite>& sprt, vector<Texture>& txtr, vector<Sprite>& shadow)
{
        ...
        vector<string>& words)
{
    Texture hangPart_1, hangPart_2, hangPart_3, hangPart_4, rope, man,
            backgroundTexture;
    Sprite hangPartSprite_1, hangPartSprite_2, hangPartSprite_3,
            hangPartSprite_4, ropeSprite, manSprite, backgroundSprite;
    Clock clock;
    Menu menuShow;
    Sound sound, clap;
    ...
    while (isLogic) {
        ...
        if (used == the_word) {
            ...
            wordToDisplay.setOrigin(
                    fRect.left + fRect.width / 2.0f,
                    fRect.top + fRect.height / 2.0f);
            wordToDisplay.setPosition(
